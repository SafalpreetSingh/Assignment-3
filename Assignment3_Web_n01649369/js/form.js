...
if (arrivaldate == ""){
$("#filter-arrivaldate").textContent = "This field cannot be empty.";
flag = true;
}

if (nights == ""){
$("#filter-nights").textContent = "This field cannot be empty.";
flag = true;
}

if (name == ""){
$("#filter-name").textContent = "This field is mandatory.";
flag = true;
}

if (email == ""){
$("#filter-email").textContent = "This field is mandatory.";
flag = true;
}

if (phone == ""){
$("#filter-phone").textContent = "This field is mandatory.";
flag = true;
}
...
$("#filter-phone").textContent = "Must be numeric.";
flag = true;
}
